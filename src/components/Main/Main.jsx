	...
	return (
		<main className={styles.main}>
			<div className={styles.row}>
				<div className={`${styles.col} ${sidebar.sidebar}`}></div>
				<div className={`${styles.col} ${model.model}`}>
						...
						{pointToggle && (
							<>
								...
								<button
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>VS CODE</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-6'
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>TS</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-7'
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>BS</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-8'
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>CSS</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-9'
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>PHP STORM</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-10'
									...
									data-normal='1m 0m 0m'
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>JS</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-11'
								...
								<button
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>GULP</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-13'
								...
								<button
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>PS</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-16'
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>BEM</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-17'
								...
								<button
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>NPM</div>
								</button>
								<button
									className={model.hotspot}
									slot='hotspot-20'
								...
								<button
									...
									data-visibility-attribute='visible'>
									<div className={model.hotspotText}>DEV TOOLS</div>
								</button>
							</>
						)}
				...
				<div className={`${styles.col} ${slider.slider}`}>
					<Swiper
						onSwiper={setSwiper}
						freeMode={true}
