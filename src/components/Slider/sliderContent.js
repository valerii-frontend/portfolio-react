const sliderContent = [
  ...
  },
  {
    name: "TypeScript",
    icon: "ts",
    p1: "TypeScript enhances JavaScript by introducing additional syntax for a more robust integration with your editor, allowing you to catch errors early in the development process.",
    p2: "With TypeScript, I leverage its understanding of JavaScript and benefit from type inference, providing excellent tooling without the need for extra code.",
    p3: "I actively work with TypeScript in my projects, demonstrating a solid understanding of its basics and principles.",
    p4: "Having hands-on experience with TypeScript, I continuously enhance my skills in real-world scenarios, contributing to its practical application.",
  },
  ...
  },
  {
    name: "React",
    icon: "react",
    p1: "React, also known as React.js or ReactJS, stands as a versatile and open-source front-end JavaScript library dedicated to building dynamic user interfaces based on reusable UI components. Maintained by Meta (formerly Facebook), it enjoys support from a vibrant community of developers and companies.",
    p2: "In my projects, I leverage the latest versions of React, embracing functional components, hooks, and CSS modules. React serves as the foundation for a range of applications, including single-page, mobile, or server-rendered projects, often integrated with frameworks like Next.js.",
    p3: "Proficient in employing advanced features such as functional components, hooks, and CSS modules, I stay current with the evolving landscape of React development.",
    p4: "Beyond the basics, I actively experiment with and integrate various tools, including routers, transition groups, and explore technologies like MongoDB, Firebase, Next.js, and TypeScript in conjunction with React.",
  },
  {
    name: "Photoshop/Gimp",
    icon: "ps",
  ...
  },
  {
    ...
    p4: `To work with the project, I also used the ticket system and Trunk Based Development approach with separate developers servers for each team member`,
  },
  {
    name: "NPM",
    icon: "npm",
